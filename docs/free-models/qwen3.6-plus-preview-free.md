...
| 能直接用吗 | 能，直接用 `qwen/qwen3.6-plus-preview:free` |
...
| 项目 | 当前信息 |
| --- | --- |
| 模型名 | Qwen3.6 Plus Preview |
| OpenRouter slug | `qwen/qwen3.6-plus-preview:free` |
| OpenRouter 页面 | https://openrouter.ai/qwen/qwen3.6-plus-preview:free |
| 当前是否免费 | 是 |
| 模态 | text → text |
...
- 有明确 slug：`qwen/qwen3.6-plus-preview:free`
...
> **Qwen3.6 Plus Preview 免费版的最大亮点：1M 超长上下文 + 免费。**
...
- 来源: https://openrouter.ai/qwen/qwen3.6-plus-preview:free
